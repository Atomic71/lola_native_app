...
import PostTrackItem from './PostTrackItem';
...
const PostTrack = ({posts, wrapperStyles = []}) => {
  return (
    <FlatList
      horizontal
      // CellRendererComponentView}
      CellRendererComponent={({item}) => {
        return <PostTrackItem {...item} />;
      }}
      ...
      data={posts}
      style={[...wrapperStyles, {flexShrink: 0, paddingBottom: 20}]}
